...
class Customer(SerializerMixin, db.Model):
    ...
    # Exclude reviews.customer to avoid recursion during serialization
...
class Item(SerializerMixin, db.Model):
    ...
    # Exclude reviews.item to avoid recursion during serialization
...
class Review(SerializerMixin, db.Model):
    ...
    # Exclude customer.reviews and item.reviews to avoid recursion during serialization
